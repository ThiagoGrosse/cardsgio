...
buscarTodosProdutos = () => {
    ...
    xhttp.open("GET", consultaTodosProdutos, false)
    xhttp.send()
...
const list = {
    create(item) {
        ...
        card.querySelector('.card-img-top').src = urlImagem + item.imagem01
        card.querySelector('.card-img-top').alt = item.tituloProduto
        card.querySelector('.card-title').innerHTML = item.tituloProduto
